...
## Example ##
Here are tjhe example of a printed board in eagle and then printed. FOr this example it was only the RC oscillator from the low cost Frequency Domain EM system. 
<img src="RC_OSCILLATOR.png" alt="drawing" width="500"/>    
